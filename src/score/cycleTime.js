...
// Jira source: derived from changelog transitions (NOT YET wired — so byStage is
// empty in live mode; P90 age still works). Mock source: seeded.
// (Integrated from teammate PR #2 — Judychiuuu.)
